...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		if(options!=null && options.width!=null){
			$popBox.css("width",options.width+"px");
			$popBox.css("margin-left",(-options.width/2)+"px");
		}
		if(options!=null && options.height!=null){
			$popBox.css("height",options.height+"px");
			$popBox.css("margin-top",(-options.height/2)+"px");
		}
