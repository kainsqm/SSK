	...
	{	
		...
		if(quesType=="1"){
 		...
 		var row = document.all.quesType1.insertRow();
			...
			num2++;
			cells[2].innerHTML="<input class=num type= text name=typeScore onblur=checkValue(this) onkeyup=value=value.replace(/[^0-9]/g,'0');total(); style=text-align:center; maxlength=2 size=3 style=height:18px; value='"+quesScore+"' bm ='"+quesType+"'>";
			//3.单选题
		}else if(quesType=="3"){
...
<body onload="total();">
	...
	<div align="center" style="margin-top: 10px;">
		<tr align="center">
			...
			<td colspan="8" align="center"><shiro:hasPermission name="kssjgl:createexam"><input type="button"
				onclick="addExampaper()" value="生成试卷" />&nbsp;&nbsp;&nbsp;&nbsp;</shiro:hasPermission>
				<shiro:hasPermission name="kssjgl:delete">
				...
				onclick="location.href='<%=path%>/controller/optionQue/toOptionque.do'" /></td>
		</tr>
	</div>
	<form name="exampaperForm" method="post" action="<%=path%>/controller/optionQue/removeQuesUpSeled.do"
		id="exampaperForm">
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="12%" class="num" align="center">总分：&nbsp;&nbsp;&nbsp;【<input
