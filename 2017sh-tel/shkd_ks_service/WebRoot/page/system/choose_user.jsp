		...
		function loadData(resultData){
	  		maingrid_gd= $("#record_list").ligerGrid({
               ...
               onCheckRow:function(checked,data,rowid,rowdata){
            	window.parent.document.getElementById("fkInsertUserName").value = data.userName;
            	window.parent.document.getElementById("fkInsertUserId").value = data.userId;
	...
	<div onkeydown="keydown();">
		...
		<form id="queryUser">
			<table class="search_table" cellpadding="3" cellspacing="3" width="100%" >
				<tr>
					<td class="td_lable">工号：</td><td class="td_value"><input type="text" name="workId" style="width: 140px" /></td>
					<td class="td_lable">姓名：</td><td class="td_value"><input type="text" name="userName" style="width: 135px" /></td>
				</tr>
				<tr>
