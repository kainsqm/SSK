	...
	{	
		...
		if(quesType=="1"){
 		...
 		var row = document.all.quesType1.insertRow();
			...
			num1++;
			cells[2].innerHTML="<input type= text class=num bm ='"+quesType+"' name=typeScore onblur=checkValue(this) onkeyup=value=value.replace(/[^0-9]/g,'0');total(); style=text-align:center; maxlength=2 size=3 style=height:18px;  value='"+quesScore+"'>";
			//2.判断改错题
		}else if(quesType=="2"){
			...
			num2++;
			cells[2].innerHTML="<input type= text class=num name=typeScore onblur=checkValue(this) onkeyup=value=value.replace(/[^0-9]/g,'0');total(); style=text-align:center; maxlength=2 size=3 style=height:18px; value='"+quesScore+"' bm ='"+quesType+"'>";
			//3.单选题
		}else if(quesType=="3"){
			...
			num6++;
			cells[2].innerHTML="<input type= text class=num name=typeScore onblur=checkValue(this) onkeyup=value=value.replace(/[^0-9]/g,'0');total(); style=text-align:center maxlength=2 size=3 style=height:18px; bm ='"+quesType+"' value='"+quesScore+"'>";
			//7.问答题
		}else if(quesType=="7"){
...
<body onload="total();">
	...
	&nbsp;（<font color="blue">难度级别：<%=questionsVO.getQuesNanduStr() %>，分类：<%=questionsVO.getBusinessType()%></font>）
	</span>
	...
	<div align="center" style="margin-top: 10px;">
		<tr align="center">
			...
			<td colspan="8" align="center"><shiro:hasPermission name="ksmbsj:scmb"><input type="button"
				onclick="addExampaper()" value="生成模板" />&nbsp;&nbsp;&nbsp;&nbsp;</shiro:hasPermission>
				<shiro:hasPermission name="ksmbsj:scsx"><input type="button" onclick="removeSelectedQues()"
				style="width: 110px;" value="删除所选考题" />&nbsp;&nbsp;&nbsp;&nbsp;</shiro:hasPermission> <input
				type="button" value="返回" id="insertOpen"
				onclick="location.href='<%=path%>/controller/exampaper/toShowRandomPage.do'" /></td>
			</td>
		</tr>
	</div>
	<form name="exampaperForm" method="post" action="<%=path%>/controller/optionQue/removeRandomQuesUpSeled.do"
		id="exampaperForm">
		<input type="hidden" name="selectQues" id="selectQues" /> <input
			...
			type="hidden" name="exampaperRemarks" id="exampaperRemarks" /> <input
			type="hidden" name="exampaperNames" id="exampaperNames" /> <input
			type="hidden" name="isIndexs" id="isIndexs" /> <input
			
			type="hidden" name="histroyFlag" id="histroyFlag"
			value="${requestScope.histroyFlag}" />
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="12%" align="center">总分：&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="tatolScore" id="tatolScore" readonly="true"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title"
								...
								<td width="92%" align="left"><b>判断题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="pdt" id="pdt"
									style="border: 0; background: transparent; text-align: center"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>判断改错题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="pdgct" id="pdgct"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>单选题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="dxt" id="dxt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>多选题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="ddxt" id="ddxt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>不定项选择</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="bdxxzt" id="bdxxzt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>填空题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class="num" name="tkt" id="tkt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>问答题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class=num name="wdt" id="wdt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr align="center" class="title">
								...
								<td width="92%" align="left"><b>案例分析题</b>&nbsp;&nbsp;&nbsp;【<input
									type="text" class=num name="alfxt" id="alfxt"
									style="border: 0; background: transparent; text-align: center"
									size="3" onblur="checkValue(this);"
									onkeyup="value=value.replace(/[^0-9]/g,'');relvalue(this);total();">】分</td>
								<td width="5%" align="center"></td>
		...
		<table class="search_table" cellpadding="3" cellspacing="3"
			...
			<tr>
				...
				<td class="td_value"><input type="text" id="examPaperName" name="examPaperName" />&nbsp;<red>*</red></td>
				<td class="td_value">试卷名称不能为空</td>
			</tr>
			<tr>
				<td class="td_lable">试卷备注：</td>
				<td class="td_value"><input type="text" id="examPaperRemark" name="examPaperRemark" />&nbsp;<red>*</red>
			...
			<tr style="margin-top: 50px;">
				<td colspan="8" align="center" "><shiro:hasPermission name="ksmbsj:tj"><input
					id="submitPrapre" type="button" value="提交" /></shiro:hasPermission>
   ...
   function addExampaper(editType){
	   location.href='<%=path%>/controller/exampaper/addExampaperRandom.do';
   }
