...
<script>
		...
		var filePath = "<%=basePath%>" + "page/imptemp/";
		  $.ajaxFileUpload({
		            url: '<%=path%>/controller/quesTions/importQuestion.do',
					type : 'post',
					dataType : "json",
								...
								$.ligerDialog
										.warn(
												...
												function(yes) {
													$("#zs")
															.html(
																	parseInt(result.errorCnt)
																			+ parseInt(result.successCnt));
													$("#cw").html(
															result.errorCnt);
													$("#zq").html(
															result.successCnt);
...
<body>
	<div class="file-box">
		<form action="" method="post" enctype="multipart/form-data">
			<input type='text' name='textfield' id='textfield' class='txt' style="width: 370px !important;margin-right: 10px" /> <input
				type='button' class='btn' value='浏览...' /> <input type="file"
				name="myFile" class="file" id="myFile" size="28"
	...
	<div class="message—div">
		<div>
			导入结果：&nbsp;&nbsp;&nbsp;&nbsp;总数<span id="zs"></span>条&nbsp;&nbsp;&nbsp;&nbsp;成功数<span
				id="zq"></span>条&nbsp;&nbsp;&nbsp;&nbsp;失败数<span id="cw"></span>条
		</div>
		<div id="er"
			style="margin-top:5px; height:90px; overflow:auto; border:#CCCCCC 1px solid; color:#FF0000;">
