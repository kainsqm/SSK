...
public class ValidatorUtil {
	...
	/** 字母和数字 */
	private static final String V_LETTER_NUMBER = "^[A-Za-z0-9]+$";

	/** 中文，数字和字母 */
	private static final String V_CHINESE_LETTER_NUMBER = "^[a-zA-Z0-9\u4e00-\u9fa5]+$";
	 ...
	 */
	/*
	 * public static boolean number_length(String value) { return
	 * match(V_PASSWORD_LENGTH, value); }
	 */
	 ...
	 */
	/*
	 * public static boolean password_reg(String value) { return
	 * match(V_PASSWORD_REG, value); }
	 */
	...
	public static boolean isLength(String str, int minLen, int maxLen) {
		if (notEmpty(str)) { // 不为空
			if (str.length() < minLen) { // 小于最少长度
				return false;
			}
			if (str.length() > maxLen) { // 大于最大长度
				return false;
			}
		}
		return true;
	...
	public static boolean isLetterAndNumber(String value) {
		return match(V_LETTER_NUMBER, value);
	}
	 ...
	 * @return
	 */
	public static boolean isChineseLetterAndNumber(String value) {
		return match(V_CHINESE_LETTER_NUMBER, value);
	}
