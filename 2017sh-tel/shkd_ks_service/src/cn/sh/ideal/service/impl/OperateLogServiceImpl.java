...
import cn.sh.ideal.dao.ItOperateLogDao;
...
public class OperateLogServiceImpl implements IOperateLogService {
	@Resource
	private ItOperateLogDao operateDao;
	...
	@Override
	public void addLog(String moduleName,String funcName,String description, Object[] logDescriptionArgsObject, Map<String,String> param){
		...
		//保存log
		OperateLog log = new OperateLog(userId,userName,DateUtil.getDateTimeStr(new Date()), ip, moduleName,funcName,description_format_result, className,methodName);
