...
@XmlRootElement(name = "GetRefIDByReservedField")
public class GetRefIDByReservedField {

    @XmlElementRef(name = "condition", namespace = "http://www.voicecyber.com/", type = JAXBElement.class)
