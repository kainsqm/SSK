...
@XmlRootElement(name = "UpdateRecordDataByID")
public class UpdateRecordDataByID {

    @XmlElementRef(name = "RefID", namespace = "http://www.voicecyber.com/", type = JAXBElement.class)
