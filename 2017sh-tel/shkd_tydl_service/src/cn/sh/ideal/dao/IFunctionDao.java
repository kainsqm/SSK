...
public interface IFunctionDao {
	...
	public List<Function> getPermissionByUser(@Param("userId") int userId,@Param("syscode") String syscode);
	...
	public List<Function> getReportRoleByUser(@Param("userId") int userId);
