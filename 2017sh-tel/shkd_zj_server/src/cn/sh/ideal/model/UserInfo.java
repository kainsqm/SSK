...
public class UserInfo{
    ...
    private String theirCenter;  //所属中心  by niewenqiang  2017-4-17
    
    
    
	public String getTheirCenter() {
		return theirCenter;
	}

	public void setTheirCenter(String theirCenter) {
		this.theirCenter = theirCenter;
	}
