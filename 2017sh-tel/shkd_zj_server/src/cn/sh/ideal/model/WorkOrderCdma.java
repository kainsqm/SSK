...
public class WorkOrderCdma {
    ...
    private String startcomplaintTime;//申告开始时间
    
    private String endcomplaintTime;//申告结束时间
    ...
    private Integer is_Qc;//是否质检
    private Integer isGl;//是否关联
	...
	public Integer getIs_Qc() {
		return is_Qc;
	}

	public void setIs_Qc(Integer is_Qc) {
		this.is_Qc = is_Qc;
	}
	...
	public String getStartcomplaintTime() {
		return startcomplaintTime;
	}

	public void setStartcomplaintTime(String startcomplaintTime) {
		this.startcomplaintTime = startcomplaintTime;
	}

	public String getEndcomplaintTime() {
		return endcomplaintTime;
	}

	public void setEndcomplaintTime(String endcomplaintTime) {
