...
public interface IUserInfoService{
	    ...
	    boolean insert(UserInfo record,String roleId);
	    ...
	    boolean releasePasswd(UserInfo user);
	    ...
	    boolean updateuserRolebyuserid(UserInfo user,String roleStr);
	    List<UserInfo> rolelist();
	    Map<String, Object>  updateimportUser(List<List<Object>> excelList,
