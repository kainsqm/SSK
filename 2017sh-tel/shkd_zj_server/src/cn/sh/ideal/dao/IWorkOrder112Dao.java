...
public interface IWorkOrder112Dao {
    ...
    */
      ...
      * 查询112任务工单 2017/5/10
      */
     List<WorkOrder112> selecttaskWorkOrder112(Map<String, String> map);
     
     /**
      * 查询112任务工单数量 2017/5/10
      * @param map
      * @return
      */
     int selecttaskWorkOrder112count(Map<String,String> map);
     
     /**
      * 修改112工单未任务工单 2017/5/16
      * @param map
      * @return
      */
     int updorder112status(Map<String,String> map);
      ...
      * 获取已领112工单任务列表
      */
     List<WorkOrder112> getyl112ordertaskList(@Param("orderlist")Set<String> orderlist);
     
     int getyl112ordertaskListcount(@Param("orderlist")Set<String> orderlist);
}