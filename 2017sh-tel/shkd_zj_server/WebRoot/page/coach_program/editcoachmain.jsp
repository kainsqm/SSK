...
String pd=request.getAttribute("pd").toString();
%> 
	...
	text-align: left;
		...
		$(function(){
		 ...
		 if(pd=="info"){
		 		...
		 		$("[name='coachproject']").attr("disabled", "disabled");
		 		$("#improve").attr("disabled", "disabled");
		 		$("#specificationlanguage").attr("disabled", "disabled");
		 		$("#politetoneoofvoice").attr("disabled", "disabled");
		 		$("#abilitytocommunicate").attr("disabled", "disabled");
		 		$("#objectionhandling").attr("disabled", "disabled");
		 		$("#flowstandard").attr("disabled", "disabled");
		 		$("#deadlyerror").attr("disabled", "disabled");
		 		$("#marketingskills").attr("disabled", "disabled");
		 		$("#tj").css("display", "none");
		 }
	...
	document.getElementById("userid").value = userid;
	 ...
	 return false;
		...
		$.ligerDialog.confirm('您确认修改吗？', function (yes) { 
				if(yes){ 
	 $.ajax({
	 		url:"<%=path%>/controller/coach/updCoachmain.do",
	 		type:"post",
			data:{
	...
	<div style="width:600px;height:400px;position: absolute;display:none;border:1px solid#b7b1b1;border-radius:5px;" id="tcc" class="tcc">
		...
		<div align="center" style="">
			<form id="myForm" method="post">
				...
				<input type="hidden" id="coachmainId" name="coachmainId"  value="${coac.coachmainId}"/>
				...
				<table cellpadding="5" cellpadding="5" width="100%" border="0" class="table_tr">
					<tr>
						...
						<td class="td2">
							<input type="text"  id="username" name="username" class="obj" value="${coac.username}"
								readonly="readonly" />
						...
						<td class="td2">
							<input class="Wdate date_text" type="text" id="starttime" name="starttime" value="${coac.starttime}"
						...
						<td class="td2">
							<input class="Wdate date_text" type="text" id="endtime" name="endtime" value="${coac.endtime}"
								onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
							<font color="#FF0000">&nbsp;*</font>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="td2" colspan="5">
							<textarea style="width: 90%;height:100px;max-height:100px;max-width:90%" id="improve" name="improve" >${coac.remaker}</textarea>
						</td>
					</tr>
					<tr>
						<td colspan="6">
					...
					<tr>
						...
						<td class="td2">
							<input type="text" id="specificationlanguage" name="specificationlanguage" value="${coacs.specificationlanguage}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td class="td1">
							礼貌语调
						...
						<td class="td2">
							<input type="text" id="politetoneoofvoice" name="politetoneoofvoice" value="${coacs.politetoneoofvoice}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td class="td1">
							沟通能力
						...
						<td class="td2">
							<input type="text" id="abilitytocommunicate" name="abilitytocommunicate" value="${coacs.abilitytocommunicate}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="td2">
							<input type="text" id="objectionhandling" name="objectionhandling" value="${coacs.objectionhandling}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td class="td1">
							业务流程规范
						...
						<td class="td2">
							<input type="text" id="flowstandard" name="flowstandard" value="${coacs.flowstandard}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td class="td1">
							致命差错数/率
						...
						<td class="td2">
							<input type="text" id="deadlyerror" name="deadlyerror" value="${coacs.deadlyerror}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="td2">
							<input type="text" id="marketingskills" name="marketingskills" value="${coacs.marketingskills}"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td class="td1">
							&nbsp;
						...
						<tr>
							<td colspan="6" align="center" 
								...
								<shiro:hasPermission name='coach:upd'>
								<input type="button" id="tj" value="提交"  onclick="updmain()"/></shiro:hasPermission>
								&nbsp;&nbsp;&nbsp;&nbsp;
