...
<body>
	...
	<div align="center" style=" margin:auto; margin-top:10px;">
		...
		<div class="title_div"><label style="margin-left:15px;">c网工单评分</label></div>
		...
		<table cellpadding="3" cellspacing="3" width="1300px" >
			<tr>
				...
				<input class="input_text"   disabled="disabled" value="${workname}"/>
		...
		<div class="button_div">
			<shiro:hasPermission name='cworder:senc'>
			<c:if test="${secflag=='0'}">
				<input type="button" value="填写意见" onclick="secqc();" id="secid"/>&nbsp;&nbsp;
			</c:if>
			</shiro:hasPermission>
			<shiro:hasPermission name='cworder:check'>
			<c:if test="${subflag!='0'}">
