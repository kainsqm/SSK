	...
	var dataFromData = [{ directionFlag: 1, text: '合格' }, { directionFlag: 0, text: '不合格'}];
		$(function () {
            ...
            maingrid_gd= $("#history_qc_list").ligerGrid({
				...
				{ display: '操作',name:'recordId', isSort: false, minWidth : 180, render: function (rowdata, rowindex, value)
	                {
	                    var h = "";
						h += "<shiro:hasPermission name='hiscwxj:qc'> <a href='javascript:void(0);' onclick='pingfen(\""+rowdata.qcId+"\");'>评分</a> </shiro:hasPermission>";
					
						h += "<shiro:hasPermission name='hiscwxj:del'> <a href='javascript:delqchis("+rowdata.qcId+")' >删除</a> </shiro:hasPermission>";
                ...
                sortName: 'recordId',
                url:'<%=path%>/controller/qchis/getcwxjQcHistory.do',
		...
		function f_search() {
			var parmItems=[{ name:"qcUserWorkid",value:$("#qcUserWorkidid").val()},
			    ...
			    maingrid_gd.options.url = '<%=path%>/controller/qchis/getcwxjQcHistory.do';//必须这么写
			...
			<table id="search_table" cellpadding="3" cellspacing="3" width="100%" >
				...
				<tr>
					<td class="td_lable">检查内容：</td>
						...
						<td class="td_lable">小结流水：</td><td class="td_value"><input type="text" id="telsumId" name="telsumId" onkeyup="input_zmszhg(this);strlenLimit(this,50);"/></td>
				...
				<tr>
					<td colspan="8" align="center">
						<shiro:hasPermission name='hiscwxj:query'>
