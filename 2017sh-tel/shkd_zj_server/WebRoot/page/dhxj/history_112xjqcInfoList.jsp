	...
	var dataFromData = [{ directionFlag: 1, text: '合格' }, { directionFlag: 0, text: '不合格'}];
		$(function () {
            ...
            maingrid_gd= $("#history_qc_list").ligerGrid({
				...
				{ display: '操作',name:'recordId', isSort: false, minWidth : 180, render: function (rowdata, rowindex, value)
	                {
	                    var h = "";
						h += "<shiro:hasPermission name='his112xj:qc'> <a href='javascript:void(0);' onclick='pingfen(\""+rowdata.qcId+"\");'>评分</a> </shiro:hasPermission>";		
						h += "<shiro:hasPermission name='his112xj:del'> <a href='javascript:delqchis("+rowdata.qcId+")' >删除</a> </shiro:hasPermission>";
	                    return h;
	                }
                },
                ...
                sortName: 'recordId',
                url:'<%=path%>/controller/qchis/get112xjQcHistory.do',
		...
		function f_search() {
			var parmItems=[{ name:"qcUserWorkid",value:$("#qcUserWorkidid").val()},
			               ...
			               { name:"telsumId",value:$("#telsumId").val()},
			    ...
			    maingrid_gd.options.url = '<%=path%>/controller/qchis/get112xjQcHistory.do';//必须这么写
			...
			<table id="search_table" cellpadding="3" cellspacing="3" width="100%" >
				...
				<tr>
					<td class="td_lable">检查内容：</td>
						...
						<td class="td_lable">电话小结流水：</td><td class="td_value">
						<input type="text" id="telsumId" name="telsumId" onkeyup="input_zmszhg(this);strlenLimit(this,50);"/>
						</td>
				...
				<tr>
					<td colspan="8" align="center">
						<shiro:hasPermission name='his112xj:query'>
