...
<head>
	...
	function closewin(){
	    window.location.href="paperList_112.jsp";
		window.close();
...
<body>
	...
	<div align="center" style=" margin:auto; margin-top:10px;">
		...
		<div class="title_div"><label style="margin-left:15px;">112小结评分</label></div>
		...
		<table cellpadding="3" cellspacing="3" width="1300px" >
			<tr>
				<td class="td_lable" width="80" >监听时间：</td><td class="td_value"><input class="Wdate date_text" type="text"  disabled="disabled" name="listentime" value="${listentime }" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"  /></td>
				<td class="td_lable" width="80" >受理时间：</td><td class="td_value"><input class="Wdate date_text" type="text" disabled="disabled" id="SLstartTime"  name="SLstartTime" value="${complaintTime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" /></td>
				<td class="td_lable" width="80" >质检员：</td><td class="td_value"><input class="input_text" type="text" name="workname" disabled="disabled" value="${workname}"/></td>
				<td class="td_lable" width="80" >受理员：</td><td class="td_value"><input class="input_text" type="text" name="agentName" disabled="disabled" id="agentName"  value="${agentName}"/></td>
				...
				<c:if test="${display!='0'}">
				<input  type="text" class="input_text" onblur="noSpecial(this);"  onkeyup="strlenLimit(this,20);noSpecial(this);"  name="deviceId" id="deviceIdid" value="${declarationNo}"/><span style="color: red">*</span>
				</c:if>
			...
			<tr>
				...
				<input type="hidden" value="${xj112autoid}" id="telsumId" name="telsumId"/>
				</td>
		...
		<shiro:hasPermission name='112xj:check'> 
			<c:if test="${subflag!='0'}">
