...
<head>
	...
	<%-- 	$(function(){
				...
				alert("upd"+workId);
			if(workId!=null){
			window.location.href="<%=path%>/controller/user/userInfobyworid.do?workId="+workId;
			}
			}
			); --%>
 			function subuser(){
				...
				if(yes){		
						$.ajax({
								url:"<%=path%>/controller/user/upduserInfo.do",
								type:"post",
								data:{
										userId:userId,
										userName:userName,
		...
		$(document).ready(function(){
			setCheck();		
			$("#theirCenter").val($("#theirCenterhidden").val());	
		});
		//-->				
		</script>
...
<body> 
	...
	<input type="hidden"  id="theirCenterhidden" value="${userinfo.theirCenter}" />
		<table cellpadding="5" cellpadding="5" width="100%"  border="0">	
			<tr>
				<td align="right"  width="60">姓名：</td><td align="left"><input type="text" maxlength="50" id="userName" onkeyup="noSpecial(this)" name="userName" value="${userinfo.userName}"/><span style="color: red">*</span></td>
			</tr>
			<tr>
				<td align="right" width="60">大工号：</td><td align="left"><input type="text"  maxlength="50" onkeyup="input_shuziyinwen(this);" id="workId" name="workId" value="${userinfo.workId}"/><span style="color: red">*</span></td>
			</tr>
			<tr>
				<td align="right" width="60">组室：</td><td align="left" ><input type="text" id="groupName" name="groupName" value="${userinfo.groupName}"/><span style="color: red">*</span></td>
			</tr>
			<tr>
				<td align="right" width="60">岗位：</td><td align="left"><input type="text" id="job"  name="job" value="${userinfo.job}"/><span style="color: red">*</span></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center" style="padding-top:7px; padding-bottom:15px;">
					<shiro:hasPermission name='user:upd'><input type="button" value="提交" onclick="subuser()" /></shiro:hasPermission>&nbsp;&nbsp;&nbsp;&nbsp;
