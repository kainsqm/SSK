...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=path%>/lib/ligerUI/js/plugins/ligerDialog.js"
			type="text/javascript"></script>
		<script language="javascript" type="text/javascript"
			src="<%=path%>/page/task/edit_taskInfo.js"></script>
		<script language="javascript" type="text/javascript"
	...
	<body>
		<div align="center" style="height: auto;">
		   <input type="hidden" id="type" value="${type}" />
			<form  method="post"
				id="myform">
				<input type="hidden" id="csrCount" name="csrCount" value="0" />
				<table border="0" cellpadding="3" cellspacing="3" width="90%">
					...
					<tr>
						...
						<td width="180">
							<input type="text" name="TASK_NAME" id="TASK_NAME"  onkeyup="strlenLimit(this,50);noSpecial(this);"  onblur="checkName();strlenLimit(this,50);noSpecial(this);"/>
							<font color="#FF0000">&nbsp;*</font>
						</td>
						<td width="459">
							是否发布
							<input type="radio" name="IS_PUBLISH" value="1" checked="checked" />
							是&nbsp;&nbsp;&nbsp;
					...
					<tr>
						...
						<td colspan="2">
						  <!-- <input class="Wdate date_text" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
							<input class="Wdate date_text" type="text" name="STARTTIME"
								onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'STARTTIME');}',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					...
					<tr>
						...
						<td colspan="2">
							<input type="hidden" id="QC_USER" name="QC_USER"
								style="width: 75%" readonly="readonly" value="" />
							<input type="hidden" id="QC_USER_WORKID" name="QC_USER_WORKID"/>
							<input type="text" style="width: 500px;" id="QC_USER_NAME"
					...
					<tr>
						...
						<td colspan="2">
							...
							<input type="hidden" id="TEL_USER" name="TEL_USER" value="" />
							<input type="hidden" id="TEL_USER_WORKID" name="TEL_USER_WORKID" value="" />
							<input type="hidden" id="papers_hid"/>
						</td>
					</tr>
					<tr>
						<td class="td_1">
						...
						<td colspan="2">
							<input type="text" id="CSR_TOP_D_COUNT" name="CSR_TOP_D_COUNT" value=""
					...
					<tr>
						<td colspan="3" style="text-align: center;">
							<input type="button" id="btn"  value="提交" onclick="addTaskSave()" />
							&nbsp;&nbsp;&nbsp;&nbsp;
