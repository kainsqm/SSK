...
<head>
	...
	<script src="<%=path%>/page/task/112/edit_order112task.js" type="text/javascript"></script>
	...
	<div align="center" style="height:auto;">
		...
		<ul>
			...
			<c:if test="${task.taskId ne null &&task.taskId !=''}">
			 ...
			 <input  name="qcUserName" type="text" id="qcUserName" <c:if test="${type=='show'}">disabled="disabled"</c:if>  value="${task.qcUserName}" readonly="readonly" onclick="ondis()"  style="width:760px ;"/><span id="qcNumber" style="color: gray;">0</span>人 <font color="#FF0000">&nbsp;*(质检员，30人以内)</font>
		...
		<table border="0" cellpadding="3" cellspacing="3" width="1000px" style="clear: both;">
			...
			<tr height="30">
				<td class="td_1">区　　局：</td>
				<td>
				<input type="text" id="test1"  name="qjtype"  /> 
				<input type="hidden" id="qjtype2" value="${task.qjtype}" />
				
				</td>
				<td class="td_1" width="90px" >申告大类：</td>
				<td>
				<input type="text" id="test11" name="sgdltype" /> 
				<input type="hidden" id="sgdltype2" value="${task.sgdltype}" />
				</td>
				<td class="td_1" width="110px">申告现象：</td>
				<td >
				<input type="text" id="test111" name="sgxxtype"  /> 
				<input type="hidden" id="sgxxtype2" value="${task.sgxxtype}" />
				</td>
				<td class="td_1" width="60px">测试代码：</td>
				<td>
				<input type="text" id="test12" name="csdmtype"  /> 
				<input type="hidden" id="csdmtype2" value="${task.csdmtype}" />
				</td>
			</tr>
			<tr height="30">
				<td class="td_1">申告备注：</td>
				<td>
				<input type="text" id="test13" name="sgbztype"  /> 
				<input type="hidden" id="sgbztype2" value="${task.sgbztype}" />
				</td>
				<td class="td_1">申告联系信息：</td>
				<td>
				<input type="text" id="test14" name="sglxtype"  /> 
				<input type="hidden" id="sglxtype2" value="${task.sglxtype}" />
				</td>
				<td class="td_1">结案方式：</td>
				<td>
				<input type="text" id="test15" name="jafstype"   /> 
				<input type="hidden" id="jafstype2" value="${task.jafstype}" />
				</td>
				<td class="td_1">受理来源：</td>
				<td>
				<input type="text" id="test16" name="sllytype"   /> 
				<input type="hidden" id="sllytype2" value="${task.sllytype}" />
				</td>
			</tr>
			<tr height="30">
				<td class="td_1">派修方向：</td>
				<td>
				<input type="text" id="test17"  name="pxfxtype"   /> 
				<input type="hidden" id="pxfxtype2" value="${task.pxfxtype}" />
				</td>
				<td class="td_1">三级故障大类：</td>
				<td>
				<input type="text" id="test18" name="sjgztype" /> 
				<input type="hidden" id="sjgztype2" value="${task.sjgztype}" />
				</td>
				<td class="td_1">三级故障修复代码：</td>
				<td>
				<input type="text" id="test19" name="gzxftype"  /> 
				<input type="hidden" id="gzxftype2" value="${task.gzxftype}" />
				</td>
