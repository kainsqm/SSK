...
<head>
	...
	var maingrid_gd;
       ...
       function f_getWhere()
		...
		window.location.href="<%=path%>/page/task/cw/task_recordordercw_list.jsp?taskId="+taskUserID+"&cDate="+cDate+"&taskName="+encodeURI(encodeURI(taskName));
		}else{//任务没有领满跳转领取界面
		window.location.href="<%=path%>/page/task/cw/task_lingquordercw.jsp?taskId="+taskUserID+"&cDate="+cDate+"&taskName="+encodeURI(encodeURI(taskName));	
		}
